subroutine mcmc(l, g0, g1, g, p, result)
  implicit none
  integer(kind=4), intent(in)::l, g0, g1, g
  real(kind = 8), dimension(0:2, l), intent(in) :: p
  integer(kind=4), dimension(l, 0:2), intent(out):: result
  ...
  integer(kind=4), dimension(l, 0:2) :: sum_counts
...
function prior(total)
  ...
  real(kind = 8), parameter, dimension(1:3) :: k = (/1.0, 1.0, 1.0/)
  real(kind = 8) :: l1, l2
  integer :: i0, i1, i2
