...
Although there are several statistical methods applied to test differential methylated loci, all of them only provide binary outcome of a locus being methylated or not. A common practice to further identify hypo- and hyper-methylated loci is based on the sign of the test statistics, which is an ad-hoc approach and ignores the uncertainty associated with the test statistics. 
## Implementation
